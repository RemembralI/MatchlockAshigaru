...
int mins[] = {228, 224, 161, 165, 277, 159, 223, 223, 158, 161, 277, 143};
int maxs[] = {796, 796, 860, 860, 859, 746, 791, 791, 855, 860, 860, 751};
...
void setupIK(){
  endpoints[RIGHT_FRONT].x = 104;
  endpoints[RIGHT_FRONT].y = 118;
  endpoints[RIGHT_FRONT].z = 263;

  endpoints[RIGHT_REAR].x = -104;
  endpoints[RIGHT_REAR].y = 118;
  endpoints[RIGHT_REAR].z = 263;

  endpoints[LEFT_FRONT].x = 52;
  endpoints[LEFT_FRONT].y = -118;
  endpoints[LEFT_FRONT].z = 263;

  endpoints[LEFT_REAR].x = -52;
  endpoints[LEFT_REAR].y = -118;
  endpoints[LEFT_REAR].z = 263;
